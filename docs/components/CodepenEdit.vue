...
export default {
    ...
    data() {
        return {
            ...
            externalScripts: [
                ...
                'https://unpkg.com/gov/dist/gov.min.js'
            ],
            externalStyles: [
                'https://unpkg.com/gov/dist/gov.min.css',
    ...
    computed: {
        data() {
            return JSON.stringify({
                title: `${this.$route.meta.title} ${this.title ? this.title.toLowerCase() : ''} - Gov example`,
                tags: ['gov', 'vue', 'bulma'],
    ...
    methods: {
        getHtml() {
            ...
            html = html.replace(/src="\/static/g, 'src="https://gov.org/static')
