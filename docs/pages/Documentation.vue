<template>
    <article class="content">
        <p>
            ...
            Gov has two core principles: 1. keep stuff simple and 2. be lightweight.
        </p>

        <p>
            We like to think that Gov is the javascript layer for your Bulma interface, since it doesn't require for it to be
