<template>
    <div>
            ...
            <div class="media-content">
                ...
                <b-message type="is-info">
                    <div class="content">
                        ...
                        <p>There's also two other variables created by Gov:</p>
                        <ol>
        ...
        <div class="media">
            ...
            <div class="media-content">
                <h3 class="subtitle">Import and use Gov</h3>
                <b-message type="is-warning">
                    Please note that <code class="javascript">import 'gov/dist/gov.css'</code> from the <router-link to="/documentation/start">start section</router-link> has been omitted.
                </b-message>
    ...
    export default {
        data() {
            return {
                ...
                // Import Bulma and Gov styles
                @import "~bulma";
                @import "~gov/src/scss/gov";
                `,
                importing: `
                import Vue from 'vue'
                import Gov from 'gov'
