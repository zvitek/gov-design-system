    ...
    <div>
            ...
            <div class="media-content">
                ...
                <b-message type="is-success">
                    <div class="content">
                        ...
                        Gov full bundle is optimized and still pretty small:
                        <ul>
        ...
        <div class="media">
            ...
            <div class="media-content">
                ...
                <div class="content">
                    ...
                    <ul>
                        <li>Script: <a href="https://unpkg.com/gov/dist/gov.min.js" target="_blank">https://unpkg.com/gov/dist/gov.min.js</a></li>
                        <li>Style: <a href="https://unpkg.com/gov/dist/gov.min.css" target="_blank">https://unpkg.com/gov/dist/gov.min.css</a></li>
                    </ul>
                </div>
        ...
        <div class="media">
            ...
            <div class="media-content">
                ...
                <p class="title is-4">Installation</p>
                <CodeView code="npm install nuxt-gov" lang="bash" expanded/>

                <p class="title is-4">Usage</p>
                <p class="content">
                    Add <a href="https://github.com/gov/nuxt-gov">nuxt-gov</a> to modules section of <code>nuxt.config.js</code>:
                </p>
                <CodeView :code="importingNuxtGov | pre" lang="javascript" expanded/>
            </div>
        </div>
    </div>
</template>
            ...
            return {
                ...
                importingNuxtGov: `
                {
                    modules: [
                        ...
                        ['nuxt-gov', { css: false, materialDesignIcons: false }],
                    ]
                }`,
                importingCDNHtml: `
                <!DOCTYPE html>
                ...
                <body>
                    ...
                    <script src="https://unpkg.com/gov/dist/components/table"></\script>
                    <script src="https://unpkg.com/gov/dist/components/input"></\script>
