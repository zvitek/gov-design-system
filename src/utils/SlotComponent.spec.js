...
import GovSlotComponent from '@utils/SlotComponent'

describe('GovSlotComponent', () => {
    const MockComponent = {
    ...
    it('is called', () => {
        const wrapper = shallowMount(GovSlotComponent, {
            propsData: {
                component: {}
            }
        })

        expect(wrapper.name()).toBe('GovSlotComponent')
