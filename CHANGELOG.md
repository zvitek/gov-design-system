...
* **New component: Breadcrumb**, [see docs](https://gov.org/documentation/breadcrumb) (thanks @mouadTaoussi)
...
* Fix #2848: incorrect inset shadow for ``gov-radio-button`` (thanks @service-paradis)
...
* **Internationalization**, Gov is now using Intl package to format dates and numbers A prop named `locale` which accept a BCP 47 language tag have been added to some components. The default value for this prop is `undefined` which will use the browser locale. It can affect the following components:
  * Progress:
...
* **New component: Image**, [see docs](https://gov.org/documentation/image)
...
* **New component: Skeleton**, [see docs](https://gov.org/documentation/skeleton)
...
* **New component: Sidebar**, [see docs](https://gov.org/documentation/sidebar)
...
* **New component: Carousel**, [see docs](https://gov.org/documentation/carousel) (thanks @apolokaklab)
...
* **New component: Datetimepicker**, [see docs](https://gov.org/documentation/datetimepicker)
...
* **New component: Rate**, [see docs](https://gov.org/documentation/rate) (thanks @apolokaklab)
...
* Fix #1625 Gov global name in UMD format
...
import { ToastProgrammatic as Toast } from 'gov'
Toast.open('Toasty!')
```
* Fix #1268 add ``$gov`` namespace for each programmatic components
```javascript
// see Toast, Snackbar, Modal, Dialog, Loading and Notification doc pages for more examples
this.$gov.toast.open('Toasty!')
```
...
* **New component: Slider**, [see docs](https://gov.org/documentation/slider) (thanks @yxngl)
* **New component: Navbar**, [see docs](https://gov.org/documentation/navbar) (thanks @wanxe)
* **New component: Progress Bar**, [see docs](https://gov.org/documentation/progress) (thanks @service-paradis)
...
* **New component: Menu**, [see docs](https://gov.org/documentation/menu)
...
* **New component: Steps**, [see docs](https://gov.org/documentation/steps) (thanks @service-paradis)
...
* **Datepicker improved**: add month picker, [see docs](https://gov.org/documentation/datepicker)
...
* **New component: Numberinput**, [see docs](https://gov.org/documentation/numberinput)
* **Loading improved**: can show a custom content, [see docs](https://gov.org/documentation/loading)
...
* **New component: Button**, [see docs](https://gov.org/documentation/button)
* **New component: Clockpicker**, [see docs](https://gov.org/documentation/clockpicker) (thanks @SharpSeeEr)
* **Notification improved**: can show a notification programmatically, [see docs](https://gov.org/documentation/notification)
...
import { Toast } from 'gov/dist/components/toast'
Toast.open('Toasty!')
```
...
* **Add nuxt-gov on docs**, [see here](https://gov.org/documentation/start) (thanks @anteriovieira)
...
* **New extension: Sortable.js**, [see here](https://gov.org/extensions/sortablejs)
...
* **New component: Tag Input**, [see docs](https://gov.org/documentation/taginput) (thanks @jgerbes)
...
* Gov now uses [MDI icons from community](https://materialdesignicons.com/) instead, you'll have to change icon names and if you use a CDN you should change:
...
* **New component: Timepicker**, [see docs](https://gov.org/documentation/timepicker)
* **New component: Checkbox Button**, [see docs](https://gov.org/documentation/checkbox)
* **New docs section: Extensions**, [see here](https://gov.org/extensions/cleavejs)
...
* **Deprecated** prompt dialog ``inputPlaceholder``, ``inputName`` and ``inputMaxlength`` props, use new ``inputAttrs`` prop, [see docs](https://gov.org/documentation/dialog)
...
* **New component: Collapse**, [see docs](https://gov.org/documentation/collapse)
* **Panel deprecated**, use new Collapse component, [old docs here](https://gov.org/documentation/panel)
...
* **New component: Datepicker**, [see docs](https://gov.org/documentation/datepicker) (thanks @bartboy011)
* **New component: Tag**, [see docs](https://gov.org/documentation/tag)
...
* **Update Bulma to v0.5.1**, changes on Sass variables naming, [see docs](https://github.com/jgthms/bulma/blob/master/CHANGELOG.md#050)
    * Gov Sass variables are also following the new convention
...
* **Removed CheckboxGroup**, just add the same ``v-model`` to multiple Checkboxes and set a ``native-value``, [see docs](https://gov.org/documentation/checkbox)
* Radio and Radio Button ``value`` prop renamed to ``native-value``
    * Add ``v-model`` support
    * Radio Buttons have to be wrapped on a field
* **Removed RadioGroup**, just add the same ``v-model`` to multiple Radios/RadioButtons and set a ``native-value`` [see docs](https://gov.org/documentation/radio)
* Remove switch ``checked`` prop

### New stuff

* **New component: Upload**, [see docs](https://gov.org/documentation/upload) (thanks @jtommy)
* Field ``position`` prop works for ``grouped`` fields
* Add ``group-multiline`` prop to field
* Add ``size`` prop to message
* #191 Add detail option (collapse) to table row, [see docs](https://gov.org/documentation/table) (thanks @wanxe)
...
* **New component: Menu**, [see docs](https://gov.org/documentation/menu) (thanks @tsctao)
* **New component: Panel**, [see docs](https://gov.org/documentation/panel) (thanks @jtommy)
* **New component: Loading**, [see docs](https://gov.org/documentation/loading) (thanks @jtommy)
* **Dropdown improved**: can add any content on it, can be triggered by hover, [see docs](https://gov.org/documentation/dropdown)
...
* Update switch animation (it was laggy) and causing weird behavior within ``<keep-alive>`` components, [see updated animation](https://gov.org/documentation/switch)
* Add tons of props to Autocomplete, [see here](https://gov.org/documentation/autocomplete)
...
* Remove ``label``, ``icon`` and ``icon-pack`` properties from **DropdownOption** thanks to the new syntax, [see docs](https://gov.org/documentation/dropdown)
...
* **New component: Autocomplete**, [see docs](https://gov.org/documentation/autocomplete)
* **Switch design overhaul**, [see new style](https://gov.org/documentation/switch)
...
* **New component: Tabs**, [see docs](https://gov.org/documentation/tabs)
