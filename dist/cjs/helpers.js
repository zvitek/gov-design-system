...
var isObject = function isObject(item) {
  return __chunk_4._typeof(item) === 'object' && !Array.isArray(item);
};
...
var mergeFn = function mergeFn(target, source) {
  ...
  if (deep || !Object.assign) {
    ...
    var replaced = Object.getOwnPropertyNames(source).map(function (prop) {
      return __chunk_4._defineProperty({}, prop, isDeep(prop) ? mergeFn(target[prop], source[prop], deep) : source[prop]);
    }).reduce(function (a, b) {
      return __chunk_4._objectSpread2({}, a, {}, b);
    }, {});
    return __chunk_4._objectSpread2({}, target, {}, replaced);
  } else {
