...
import { V as VueInstance, s as setVueInstance } from './chunk-c8bb346c.js';
import './chunk-3ab30214.js';
import { _ as _defineProperty, c as _toConsumableArray, b as _typeof } from './chunk-6ea13200.js';
import { toCssWidth, getValueByPath, indexOf, multiColumnSort, escapeRegExpChars, removeDiacriticsFromString } from './helpers.js';
import './chunk-1ed1df71.js';
import { C as Checkbox } from './chunk-159bb10c.js';
import './chunk-57016ae0.js';
import { I as Input } from './chunk-0ff64db3.js';
import { I as Icon } from './chunk-e0af83df.js';
import { S as SlotComponent } from './chunk-7aa14550.js';
...
var script$1 = {
  name: 'GovTable',
  components: (_components = {}, _defineProperty(_components, Checkbox.name, Checkbox), _defineProperty(_components, Icon.name, Icon), _defineProperty(_components, Input.name, Input), _defineProperty(_components, SlotComponent.name, SlotComponent), _defineProperty(_components, __vue_component__.name, __vue_component__), _components),
  inheritAttrs: false,
    ...
    newColumns: function newColumns() {
      ...
      if (this.columns && this.columns.length) {
        return this.columns.map(function (column) {
          var TableColumnComponent = VueInstance.extend(__vue_component__);
...
export { __vue_component__$1 as GovTable, __vue_component__ as GovTableColumn };
